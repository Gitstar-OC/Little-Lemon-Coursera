...
- Below are some useful github extension that you should use to make your work easier
...
- Below are meta tags that specifies the format 
...
- Below are meta tags for responsive design
